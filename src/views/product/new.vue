...
<el-steps :active="2" align-center>
  ...
  <el-step title="选择商品关联"></el-step>
      ...
      <el-form-item label="副标题" required prop="zhaiyao">
        <el-col :span="11">
          <el-input v-model="ruleForm.zhaiyao"></el-input>
        </el-col>
      </el-form-item>
      <el-form-item label="商品品牌" required prop="click">
        <el-col :span="11">
          <el-input v-model="ruleForm.click"></el-input>
        </el-col>
      </el-form-item>
      <el-form-item label="商品介绍" required prop="img_url">
        <el-col :span="11">
          <el-input v-model="ruleForm.img_url"></el-input>
        </el-col>
      </el-form-item>
       <el-form-item label="商品货号" required prop="img_url">
        <el-col :span="11">
          <el-input v-model="ruleForm.img_url"></el-input>
        </el-col>
      </el-form-item>
      <el-form-item label="商品售价" required prop="sell_price">
        <el-col :span="11">
      ...
      <el-form-item label="商品库存" required prop="stock_quantity">
        <el-col :span="11">
